...
int main(int argc, char** argv)
{
	...
	std::string samples_file = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
			+ std::string(argv[2]) + "/samples.txt";
	std::string roadmap_file = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
			+ std::string(argv[2]) + "/roadmap.txt";
	std::string labelWeight_file = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
			+ std::string(argv[2]) + "/labelWeights.txt";
	std::string mostPromisingLabels_file = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
	...
	traj = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
	...
	// write in time
	std::string time_file = "../motoman_manipulation/newChapter/" + std::string(argv[1]) + "/scenario" 
