...
int main(int argc, char** argv)
{
	...
	std::string samples_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
		+ std::string(argv[2]) + "/" + parameter + "/roadmaps/samples_" + std::string(argv[4]) + "_" + std::string(argv[5]) + ".txt";
	std::string roadmap_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
		+ std::string(argv[2]) + "/" + parameter + "/roadmaps/roadmap_" + std::string(argv[4]) + "_" + std::string(argv[5]) + ".txt";
	std::string labelWeight_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
	+ std::string(argv[2]) + "/" + parameter + "/roadmaps/labelWeights_" + std::string(argv[4]) + "_" + std::string(argv[5]) + ".txt";
	std::string mostPromisingLabels_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
	+ std::string(argv[2]) + "/" + parameter + "/roadmaps/mostPromisingLabels_" + std::string(argv[4]) + "_" + std::string(argv[5]) + ".txt";
	...
	if (astar_solver.getFailureIndicator() == true or mcr_gsolver.getFailureIndicator() == true 
		...
		or maxsuccess_esolver.getFailureIndicator() == true or mcrmc_gsolver.getFailureIndicator() == true)
	{
		// will not submit the statistics but just to report failure
		std::string failureIndicator_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario"
	...
	else
	{
		...
		// We don't check success in planning, we check them in executing in pybullet
		...
		// write the statitics
		// std::string statistics_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario"
		...
		traj = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
		...
		traj = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
			+ std::string(argv[2]) + "/" + parameter + "/trajectories/MCRMCGtraj_" + std::string(argv[4]) 
				+ "_" + std::string(argv[5]) + ".txt";
		mcrmc_gsolver.writeTrajectory(traj);

		// write in time
		std::string time_file = "../roadmap_generator/benchmark/new_experiments/" + std::string(argv[1]) + "/scenario" 
			+ std::string(argv[2]) + "/" + parameter + "/trajectories/times_" + std::string(argv[4]) 
				+ "_" + std::string(argv[5]) + ".txt";
